...
const NavBar = () => {
    ...
    const handleClick = () => {
      if (session && session.user) {
        ...
        alert(`User: ${session.user.name}, Email: ${session.user.email}`);
      } else {
            ...
            <nav className="grid-layout  gap-4 max-w-[1200px] h-[48px] w-full mx-auto">
                ...
                <div className="col-start-2 col-end-3 flex justify-center overflow-visible w-full h-12 max-h-[90vh]"    >
                    <div className="w-full mt-0">
                        <button className="text-link-secondary bg-white max-w-full mx-auto leading-6 font-normal text-left border rounded-md w-full px-4 flex h-12 justify-between items-center border-text-disable">
