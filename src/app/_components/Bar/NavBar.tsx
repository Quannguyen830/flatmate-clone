...
const NavBar = () => {
    ...
    return (
        <header className="w-full z-[200] p-[] sticky bg-white top-0 flex items-center justify-center border-b leading-6 banner-blue" style={{
            padding: '22px 1rem calc(21px)'
        }}>
            <nav className="grid-layout gap-4 max-w-[1200px] h-[48px] w-full mx-auto">
                {/* Logo */}
                <div className="col-start-1 col-end-2 row-start-1 row-end-1 block">
                ...
                {/* Search Bar */}
                <div className="col-start-2 col-end-3 row-start-1 row-end-1 flex justify-center overflow-visible w-full h-12 max-h-[90vh]"    >
