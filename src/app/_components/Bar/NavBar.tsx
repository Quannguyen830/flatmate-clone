    ...
    return (
        <header className="w-full z-[200] px-[22px] py-4 sticky bg-white top-0 flex items-center justify-center border-b leading-10 banner-blue">
            <nav className="flex gap-4 max-w-[1200px] h-[48px] w-full mx-auto">
                        ...
                        {!isSearchVisible && (
                            <button
                                ...
                                <div className="h-8 flex items-center leading-6">
                                    ...
                                    <div className="w-full leading-6 font-normal cursor-pointer">
                                        <div>
                ...
                <ul className="w-[400px] h-full flex justify-evenly items-center text-center m-0 p-0 list-none">
                    <li className="m-0">
                        <a href="/shortlist" className="hover:bg-[#f9f9f9] tracking-[0.0125rem] text-text-primary items-center px-2 py-2 text-sm leading-5 font-bold rounded-[0.5rem] transition duration-250 no-underline">
                            Shortlist
                        </a>
                    </li>
                    <li className="m-0">
                        <a href="#" className="hover:bg-[#f9f9f9] tracking-[0.0125rem] text-text-primary items-center px-2 py-2 text-sm leading-5 font-bold rounded-[0.5rem] transition duration-250 no-underline">
                            Messages
                        </a>
                    </li>
                    <li className="m-0">
