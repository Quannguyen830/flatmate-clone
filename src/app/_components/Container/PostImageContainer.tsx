...
const PostImageContainer: React.FC<ImageProps> = ({ imagesList, imageLength }) => {
    return (
            ...
            <a href='#' className="cursor-pointer block h-full">
                <div className="h-full relative">
                    {imagesList?.map((image, index) => (
                        <div key={index} className="h-full relative w-auto">
                            <ul className="h-full">
                            ...
                            <LeftNextButton className='opacity-0 group-hover:opacity-100'></LeftNextButton>

                            <RightNextButton className='opacity-0 group-hover:opacity-100'></RightNextButton>
